package com.samay.commonlib.shell;
...
public class ShellUtils {
     ...
     *         null and {@link CommandResult#errorMsg} is null. if a@link
    ...
    /**
     * result of command {@link CommandResult#result} means result of command, 0
     * means normal, else means error, same to excute in linux shell
